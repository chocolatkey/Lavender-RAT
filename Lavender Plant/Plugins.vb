...
Public Interface IPlugin
    ...
    ''' <returns>Was plugin able to use data?</returns>
    Function Func(ByVal sock As Integer, Optional ByVal A As String() = Nothing, Optional ByVal B As Byte() = Nothing) As Boolean
End Interface